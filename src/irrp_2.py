...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 11 23:06:47 2018
...
class IRRP2:
    ...
    def get_argument(self):
        ...
        p.add_argument("-f", "--file", help="Filename",
                       required=True)
    ...
    def main(self):
        self.pi = pigpio.pi()  # Connect to self.pi.
        ...
        if self.RECORD:  # Record.
            ...
            # Ignore glitches.
            self.pi.set_glitch_filter(self.GPIO, self.GLITCH)

            self.cb = self.pi.callback(self.GPIO, pigpio.EITHER_EDGE, self.cbf)
        ...
        self.pi.stop()  # Disconnect from self.pi.
